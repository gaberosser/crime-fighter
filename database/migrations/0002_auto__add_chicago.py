...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Chicago'
        db.create_table(u'database_chicago', (
            ('number', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('case_number', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('block', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('iucr', self.gf('django.db.models.fields.IntegerField')()),
            ('primary_type', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('location_type', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ...
            ('x_coord', self.gf('django.db.models.fields.IntegerField')()),
            ('y_coord', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'database', ['Chicago'])


    def backwards(self, orm):
        # Deleting model 'Chicago'
        db.delete_table(u'database_chicago')
    ...
    models = {
        ...
        u'database.chicago': {
            ...
            'iucr': ('django.db.models.fields.IntegerField', [], {}),
