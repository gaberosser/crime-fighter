...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dataset.time_from'
        db.add_column(u'database_dataset', 'time_from',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dataset.time_to'
        db.add_column(u'database_dataset', 'time_to',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dataset.time_from'
        db.delete_column(u'database_dataset', 'time_from')

        # Deleting field 'Dataset.time_to'
        db.delete_column(u'database_dataset', 'time_to')
