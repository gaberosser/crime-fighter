...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChicagoDivision'
        db.create_table(u'database_chicagodivision', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='chicagodivision_set', to=orm['database.DivisionType'])),
            ('mpoly', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=2028)),
        ))
        db.send_create_signal(u'database', ['ChicagoDivision'])

        # Adding unique constraint on 'ChicagoDivision', fields ['name', 'type']
        db.create_unique(u'database_chicagodivision', ['name', 'type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ChicagoDivision', fields ['name', 'type']
        db.delete_unique(u'database_chicagodivision', ['name', 'type_id'])

        # Deleting model 'ChicagoDivision'
        db.delete_table(u'database_chicagodivision')
    ...
    models = {
        ...
        u'database.chicago': {
            ...
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {'srid': '2028'}),
        ...
        u'database.chicagodivision': {
            'Meta': {'unique_together': "(('name', 'type'),)", 'object_name': 'ChicagoDivision'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mpoly': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'srid': '2028'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'chicagodivision_set'", 'to': u"orm['database.DivisionType']"})
        },
        u'database.cris': {
