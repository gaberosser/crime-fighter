...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Chicago.y_coord'
        db.delete_column(u'database_chicago', 'y_coord')

        # Deleting field 'Chicago.x_coord'
        db.delete_column(u'database_chicago', 'x_coord')


        # Changing field 'Chicago.location'
        db.alter_column(u'database_chicago', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=2028))

    def backwards(self, orm):
        # Adding field 'Chicago.y_coord'
        db.add_column(u'database_chicago', 'y_coord',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Chicago.x_coord'
        db.add_column(u'database_chicago', 'x_coord',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Chicago.location'
        db.alter_column(u'database_chicago', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')())
