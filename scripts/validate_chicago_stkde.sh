...
# set the run type
MODULE=scripts.validate_chicago_stkde
...
echo "$MODULE $location $crime_type" >> this_is_what_legion_called.log
python -m $MODULE $location $crime_type
